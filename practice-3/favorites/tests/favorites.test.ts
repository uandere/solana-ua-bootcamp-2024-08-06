...
describe("Writes our favorites to the blockchain", () => {
    ...
    it("Is initialized!", async () => {
        ...
        await airdropIfRequired(anchor.getProvider().connection, user.publicKey, 0.5 * web3.LAMPORTS_PER_SOL, 1 * web3.LAMPORTS_PER_SOL);
